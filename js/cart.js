...
function addToCart(event){ 
    ...
    // let itemContainer = document.getElementById('myCart')
    ...
    <td><input type = 'number' class = 'num' value = '1' min='1' max='10'></td>
    <td class="uk-text-truncate total-price"><h3>${itemPrice}</h3></td>
    <td><button class="uk-button uk-button-danger btn" type="button">Xóa</button></td>`
...
//     let sanpham = [itemImage, itemName, itemPrice,grandTotal]
//     const mysp = JSON.stringify(sanpham);
//     localStorage.setItem('items', mysp);

//     let getjson = localStorage.getItem('items')
//     let sp = JSON.parse(getjson);
//  console.log(sp);
}
...
function grandTotal(){
    ...
    grand_total.children[0].innerText = total+"đ"
